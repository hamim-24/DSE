...
const MathematicsPage: React.FC = () => {
  ...
  const themeColor = "#9333ea" // purple-600
  ...
  // Extract unique content formats from mathematics courses
  const contentFormats = extractContentFormats(mathCourses)
    ...
    <div className="py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold">গণিত</h1>
        </div>

        {/* Banner */}
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl shadow-md p-8 mb-8 text-white relative overflow-hidden">
          <div className="absolute inset-0 opacity-10">
            <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/2090658/pexels-photo-2090658.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')] bg-cover bg-center"></div>
          </div>
          <div className="relative z-10">
            <h2 className="text-2xl font-bold mb-2">গণিত কোর্সসমূহ</h2>
            <p className="text-lg opacity-90 max-w-2xl">
              গণিতের মৌলিক ধারণা থেকে শুরু করে উন্নত বিষয়গুলো সম্পর্কে জানুন। আমাদের ইন্টারেক্টিভ কোর্সগুলো আপনাকে গণিতের জটিল ধারণাগুলো
